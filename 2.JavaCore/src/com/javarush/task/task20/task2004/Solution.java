...
/*
Читаем и пишем в файл статики
Реализуй логику записи_в/чтения файла для класса ClassWithStatic
Метод load должен инициализировать объект типа Solution.ClassWithStatic включая статические поля данными из файла
